...
import { VyDropdown } from "../base/vyDropdown";
...
export function MusicMenu({authToken, musicData, className, cardFront, setCardFront}: { authToken?: string, musicData: MusicCardData, className?: string, cardFront: CardFrontOptions, setCardFront: React.Dispatch<React.SetStateAction<CardFrontOptions>> }) {
    ...
    return (
        <VyDropdown
            ...
            btnBgClass='vy-bg-white'
            menuPosition="dropdown-menu-start"
            dropdownBgClass="vy-bg-white"
            btnText=''
            dropdownContent={MusicMenuDropdown({ authToken: authToken, musicData: musicData, cardFront: cardFront, setCardFront: setCardFront, closeDropdown: closeDropdown, openDropdown: openDropdown})}
